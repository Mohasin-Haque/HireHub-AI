...
import { getInterviews } from '@/lib/actions/shared';
        ...
        <Card key={interview.id}>
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                <CardTitle className="text-lg">{interview.jobs.title}</CardTitle>
                <CardDescription>
                  Interview with {interview.jobs.companies.name}
                </CardDescription>
              </div>
              <Badge
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Here are your upcoming and past interviews.
        </p>
      </header>
