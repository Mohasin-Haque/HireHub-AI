-- Participants may view the two members of a direct conversation, including
-- the profile fields needed by the chat UI. Direct table reads remain limited
-- to a caller's own participant row.
